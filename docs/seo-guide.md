...
## v6.3.14 SEO audit notu

Her dil sayfasinda canonical, hreflang, Open Graph ve Twitter meta alanlari kontrol edilmelidir.
`og:url` degeri canonical URL ile ayni olmalidir.
EN sayfalar `en_US`, TR sayfalar `tr_TR` og locale degeri kullanmalidir.
